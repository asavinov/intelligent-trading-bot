...
"""
Create one output file from input files of different types: depth, futures, klines.
...
Output is one file with all the columns from input files.
Futures columns are prefixed and suffixed (optionally) in order to distinguish them from klines data.
"""
...
def main(args=None):
    ...
    # Create common 1m index and empty data frame
