...
def generate_signal_columns(df, model, buy_score_column_avg, sell_score_column_avg):
    ...
    #
    # Apply rules based on thresholds to produce output signal
    #
...
def aggregate_score(df, score_column_avg: str, score_columns: Union[List[str], str], point_threshold, window):
    """
    ...
    df[score_column_avg] = score_column
